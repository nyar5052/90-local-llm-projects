...
test-cov: ## Run tests with coverage
	python -m pytest tests/ -v --cov=src/docker_gen --cov-report=term-missing
...
run-cli: ## Run CLI (use ARGS="generate --stack 'flask' --env dev")
	python -m src.docker_gen.cli $(ARGS)
