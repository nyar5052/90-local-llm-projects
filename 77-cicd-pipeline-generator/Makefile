...
test-cov: ## Run tests with coverage
	python -m pytest tests/ -v --cov=src/cicd_gen --cov-report=term-missing
...
run-cli: ## Run CLI (use ARGS="generate --platform github-actions")
	python -m src.cicd_gen.cli $(ARGS)
