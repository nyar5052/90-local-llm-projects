...
lint: ## Run linting checks
	python -m py_compile src/debate_gen/core.py
	python -m py_compile src/debate_gen/cli.py

run: ## Run CLI (use ARGS="generate --subject 'technology'")
	python -m debate_gen.cli $(ARGS)
