...
lint: ## Run linting
	python -m py_compile src/sql_gen/core.py
	python -m py_compile src/sql_gen/cli.py

run-cli: ## Run CLI (use ARGS="generate --query 'show users'")
	python -m src.sql_gen.cli $(ARGS)
